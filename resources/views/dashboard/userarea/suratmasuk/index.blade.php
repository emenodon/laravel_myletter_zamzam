      ...
      <div class="col-12 col-md-12 col-lg-12">
        <div class="card">
          <div class="card-header">
            <div class="col-12 col-md-12 col-lg-12">
              <a  href="{{ route('suratmasukuser.create') }}" class="btn btn-primary">Tambah Surat </a> &nbsp
              <a  href="{{route('suratmasukuser.show', Auth::user()->nama_lengkap)}}" class="btn btn-warning">Edit Surat </a>
